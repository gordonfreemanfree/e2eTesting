...
export class SmartSnarkyNet10x10 extends SmartContract {
  ...
  @state(Field) layer3Hash = State<Field>(); // stored state for Layer3
  ...
  @method initState(
    layer1: SnarkyLayer1_8x8,
    layer2: SnarkyLayer2_10x10,
    layer3: SnarkyLayer2_10x10
  ) {
    super.init();
    ...
    this.layer3Hash.set(Poseidon.hash(layer3.toFields()));
